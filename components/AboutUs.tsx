...
const AboutUs: React.FC = () => {
  return (
    <section id="introduction" className="py-20 px-4 container mx-auto dark:bg-[#0D1A26]">
      <SectionTitle backgroundText="INTRODUCTION" foregroundText="INTEGRATED ADVANTAGE" />
      
      <div className="max-w-3xl mx-auto mt-12">
        <div className="space-y-6 text-zinc-600 dark:text-zinc-300 text-left">
          <p>
          ...
          <div className="pt-4">
            <button 
              className="inline-block font-oswald tracking-widest text-red-600 dark:text-red-400 border-b-2 border-[#B9A470] pb-1 hover:text-[#B9A470] hover:scale-105 hover:-translate-y-1 transition-all duration-300 bg-transparent border-0 border-b-2"
              onClick={() => {
